...
pop_1_4_f = sum(by_gender$Females[c(1, 12, 23, 34), 3])
pop_1_4_m = sum(by_gender$Males[c(1, 12, 23, 34), 3])
...
pop_pt = data.frame(Age_group = c("1-4", "1-4", "5-14", "5-14", "15-24", "15-24", "25-44", "25-44", "45-64", "45-64",
                                  "65-74","65-74", "75 plus", "75 plus"), 
                    gender = rep(c("Female", "Male"), len = 14),
                    Population = c(pop_1_4_f, pop_1_4_m, pop_15_24_f, pop_15_24_m, pop_25_44_f, pop_25_44_m, pop_45_64_f, pop_45_64_m,
